# Welcome, finclude, to the 2025 TDI Global Hackathon!
...
| **GitHub**        | [Repo](https://github.com/db-hackathon/finclude)                                                                             | Your team's code repository.                                            |
| **Terraform Cloud** | [Workspace](https://app.terraform.io/app/db-hackathon-2025/workspaces/hack-team-finclude)                                            | Optional Infrastructure as Code for GCP.                                |
| **OpenShift**     | [Console](https://console-openshift-console.apps.hackathon.francecentral.aroapp.io/k8s/cluster/projects/finclude-official) | Optional container platform for deployments.                            |
...
*   **RedHat OpenShift:** Visit the [OpenShift Console](https://console-openshift-console.apps.hackathon.francecentral.aroapp.io/k8s/cluster/projects/finclude-official) and select **AAD** to log in.
...
Infrastructure SA (`infrastructure@hack-team-finclude.iam.gserviceaccount.com` Use this for deploying resources from GitHub Actions or Terraform Cloud. It has the same permissions as a human team member.

Workload SA (`workload@hack-team-finclude.iam.gserviceaccount.com`): Attach this to your compute resources (e.g., Cloud Run, Cloud Functions). It has the following roles:
...
* vars.APP_ENGINE_DEFAULT_SA_EMAIL - The email address of the default App Engine service account.: hack-team-finclude@appspot.gserviceaccount.com
* vars.APP_ENGINE_DEFAULT_SA_ID - The fully qualified name of the default App Engine service account.: projects/hack-team-finclude/serviceAccounts/hack-team-finclude@appspot.gserviceaccount.com
* vars.COMPUTE_DEFAULT_SA_EMAIL - The email address of the default Compute Engine service account.: 530746821330-compute@developer.gserviceaccount.com
* vars.COMPUTE_DEFAULT_SA_ID - The fully qualified name of the default Compute Engine service account.: projects/hack-team-finclude/serviceAccounts/530746821330-compute@developer.gserviceaccount.com
...
* vars.OPENSHIFT_NAMESPACE - The OpenShift namespace for your team: finclude-official
...
* app_engine_default_sa_email - The email address of the default App Engine service account.: hack-team-finclude@appspot.gserviceaccount.com
* app_engine_default_sa_id - The fully qualified name of the default App Engine service account.: projects/hack-team-finclude/serviceAccounts/hack-team-finclude@appspot.gserviceaccount.com
* compute_default_sa_email - The email address of the default Compute Engine service account.: 530746821330-compute@developer.gserviceaccount.com
* compute_default_sa_id - The fully qualified name of the default Compute Engine service account.: projects/hack-team-finclude/serviceAccounts/530746821330-compute@developer.gserviceaccount.com
...
* openshift_namespace - The OpenShift namespace for your team: finclude-official
...
*   Your team has a project and namespace named `finclude-official`.
